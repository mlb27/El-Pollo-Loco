class Character extends MovableObject {
    ...
    constructor() {
        super().loadImage("img/game/2_character_pepe/2_walk/W-21.png");
    ...
    bounceAfterStomp() {
        ...
        this.stompProtectionTimeout = setTimeout(() => {
            this.world.runWhenActive(() => this.stompProtectionActive = false);
        }, 500);
    }
    ...
    knockBackFrom(enemy) {
        ...
        this.speedY = 5;
        this.knockbackTimeout = setTimeout(() => {
            this.world.runWhenActive(() => this.stopKnockback());
        }, 500);
    }
    ...
    playCharacterAnimation() {
        if (this.isDead() || this.isFrozen || this.isPaused()) return;
